...
export default function AdminDashboard({ user }: { user: any }) {
  ...
  const seedPotentialPartners = async () => {
    const defaultPartners = [
      { name: 'Carmangeria Ozana', type: 'carmangerie', website: 'https://carmangeriaozana.ro/', city: 'Bucuresti' },
      { name: 'Laptaria cu Caimac', type: 'lactate', website: 'https://laptariacucaimac.ro/', city: 'Bucuresti' },
      { name: 'Băcănia Veche', type: 'mixt', website: 'https://bacaniaveche.ro/', city: 'Bucuresti' },
      { name: 'Carmangeria Godac', type: 'carmangerie', website: 'https://godac.ro/', city: 'Bucuresti' },
      { name: 'Lăptăria Bradet', type: 'lactate', website: 'https://laptariabradet.ro/', city: 'Bucuresti' },
      { name: 'Băcănia Rod', type: 'mixt', website: 'https://bacaniarod.ro/', city: 'Bucuresti' },
      { name: 'Carmangeria Botosani', type: 'carmangerie', website: 'https://carmangeriabotosani.ro/', city: 'Bucuresti' },
      { name: 'Carmangeria Dumi', type: 'carmangerie', website: 'https://carmangeriadumi.ro/', city: 'Bucuresti' },
      { name: 'Mestesugari de Gusturi', type: 'mixt', website: 'https://mestesugaridegusturi.ro/', city: 'Bucuresti' },
      { name: 'Premium Meat', type: 'carmangerie', website: 'https://premiummeat.ro/', city: 'Bucuresti' },
      { name: 'Zimbria', type: 'lactate', website: 'https://zimbria.ro/', city: 'Bucuresti' },
      { name: 'Priceputu', type: 'mixt', website: 'https://priceputu.ro/', city: 'Bucuresti' },
      { name: 'Bacania Yama', type: 'mixt', website: 'https://bacaniayama.ro/', city: 'Bucuresti' },
      { name: 'Invie Traditia', type: 'mixt', website: 'https://invietraditia.ro/', city: 'Bucuresti' },
      { name: 'Codrul Boieresc', type: 'mixt', website: 'https://codrulboieresc.ro/', city: 'Bucuresti' },
      { name: 'Fabricuta de Lactate', type: 'lactate', website: 'https://fabricutadelactate.ro/', city: 'Bucuresti' },
      { name: 'Artesana', type: 'lactate', website: 'https://artesana.ro/', city: 'Bucuresti' },
      { name: 'Lactate Acasa', type: 'lactate', website: 'https://lactateacasa.ro/', city: 'Bucuresti' },
      { name: 'Comalat', type: 'lactate', website: 'https://comalat.ro/', city: 'Bucuresti' },
      { name: 'Macelaria Ghita', type: 'carmangerie', website: 'https://macelariaghita.ro/', city: 'Bucuresti' },
      { name: 'La Toma', type: 'mixt', website: 'https://latoma.ro/', city: 'Bucuresti' },
      { name: 'Bucate Romanesti', type: 'mixt', website: 'https://bucate-romanesti.ro/', city: 'Bucuresti' },
    ];
